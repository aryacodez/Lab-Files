1. Develop a JDBC Application that prompts the end-user to enter the A/C number and displays the A/C details. If account does not exist with that account number then display error message.
